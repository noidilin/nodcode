...
export type GetCreditsBalance = typeof getAvailableCreditsBalance;

export function createRequireCreditsBalance(
  getCreditsBalance: GetCreditsBalance = getAvailableCreditsBalance,
) {
...
export const requireCreditsBalance = createRequireCreditsBalance();
